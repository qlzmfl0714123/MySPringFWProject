...
public class OrderSpringTest {
    ...
    void testShoppingCart() {
        ...
        assertNotNull(shoppingCart.getProducts(), "Product 리스트가 null이면 안 됩니다.");
        ...
        System.out.println("ShoppingCart 테스트 통과: " + shoppingCart);
    }
    ...
    void testOrderService() {
        ...
        double expectedTotalPrice = 150000.0 + 800000.0;
        double actualTotalPrice = orderService.calculateOrderTotal();
        assertEquals(expectedTotalPrice, actualTotalPrice, 1e-6, "주문 총액이 정확하게 계산되어야 합니다.");
